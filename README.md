...
- [v0.1.8](https://github.com/limeflash/hysteria-keenetic/releases/tag/v0.1.8)
...
wget -O hysteria-manager.ipk https://github.com/limeflash/hysteria-keenetic/releases/download/v0.1.8/hysteria-manager_aarch64-3.10.ipk
